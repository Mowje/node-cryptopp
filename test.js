...
var fuzzingRsaValid = cryptopp.rsa.verify(rsaSignTest, crypto.randomBytes(crypto.randomBytes(1)[0] + 1).toString('hex'), rsaKeyPair.modulus, otherRsaSignKeyPair.publicExponent);
